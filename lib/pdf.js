...
function renderSlip(doc, data, box, logoImg) {
  ...
  const addressText = (data.company && data.company.address) ? String(data.company.address) : '';
  ...
  // Address under CNPJ in middle column
  ...
  {
    const contactsRaw = (data.company && data.company.contacts) ? String(data.company.contacts).replace(/\u0007/g, ' \u0007 ') : '';
